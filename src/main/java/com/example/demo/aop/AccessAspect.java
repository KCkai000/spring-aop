...
public class AccessAspect {
	...
	//@Around(value = "execution(* com.example.demo.aop.FloorService.enterFloor(..))")  5只有一個實做的話可以用intefACE
	...
	public Object checkAccess(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		if(accessController.hasAccess(username, floor)) {
			...
			System.err.printf("[AOP] %s 未授權進入, 進入 %d 樓 %n", username, floor);
			throw new SecurityException("未授權進入樓層");
		}
	}
}
